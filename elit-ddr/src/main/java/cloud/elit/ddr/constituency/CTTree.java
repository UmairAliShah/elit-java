...
//  =================================== Constructor ===================================
    ...
    private void init() {
        empty_category_map = new Int2ObjectOpenHashMap<>();
        ...
        root.flatten().forEach(this::initAntecedent);
    }
...
//  =================================== Getters ===================================
    ...
    /**
     * @return a terminal node in this tree with respect to its form ID.
     */
    ...
    public List<CTNode> getPredicates() {
        return tokens.stream().filter(CTNode::isPredicate).collect(Collectors.toList());
    }
...
//	{
//		return get(terminal_id, height) != null;
//	}
//	
...
//  =================================== Normalize ===================================
    ...
    public void normalizeIndices() {
        ...
        Int2ObjectMap<List<CTNode>> m_org = getCoIndexMap(root, new Int2ObjectOpenHashMap<>());
        if (m_org.isEmpty()) return;

        List<Entry<Integer, List<CTNode>>> ps = new ArrayList<>(m_org.int2ObjectEntrySet());
        ps.sort(Entry.comparingByKey());
