...
public class ENUtils {
    ...
    static private final Set<String> S_GET = DSUtils.toHashSet("getForm", "gets", "got", "gotten", "getting");
...
//	static private final Set<String> S_BE_FINITE = DSUtils.toHashSet("am","is","was","are","were");
    ...
    /**
     * @return {@code true} if the specific word form is either "be", "become", or "getForm".
     */
